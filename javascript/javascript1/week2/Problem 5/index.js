// Problem5: Candy helper optional
...
/* We are at the candystore. We have taken some shovels of the caramel
   ...
   Create a function called addCandy. It has two parameters:
        ...
        . candyType - specifies the candy type. Could be 'sweet, chocolate, 
          toffee or chewing-gum'
        . weight - specifies the weigth of the candy in grams

    The function should add the price of the candy to an array called boughtCandyPrices
    using push 
...
/* Now create a variable called amountToSpend and assign it to Math.random() * 100.   
   You can read about Math.random here
   ...
   If the user can buy more candy the console.log the following: "You can buy more, so 
   please do!". If the user cant buy more console.log the following: "Enough candy for you!"
